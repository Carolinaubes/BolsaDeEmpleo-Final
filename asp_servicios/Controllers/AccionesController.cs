...
namespace asp_servicios.Controllers
{
    ...
    {
        private IAccionesAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public AccionesController(IAccionesAplicacion? iAplicacion,
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                var entidad = JsonConversor.ConvertirAObjeto<Acciones>(
