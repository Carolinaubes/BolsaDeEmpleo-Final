...
namespace asp_servicios.Controllers
{
    ...
    {
        private IPostulacionesAplicacion? iAplicacion = null; //En PostulacionesAplicacion estan los metodos ya validados que incluyen las conexiones (los metodos sin validar los tiene PostulacionesRepositorio)
        private TokenController? tokenController = null; //Se usa para autentificar 

        public PostulacionesController(IPostulacionesAplicacion? iAplicacion,
        ...
        public string Listar()
        {
            ...
            try
            {
                ...
                //Esta linea le manda la el StringConnection a aplicacion, el cual internamente le asigna esta conexion al PostulacionesRepositorio
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                //En este punto, ya se valido que el token es correcto, continuo...
                var entidad = JsonConversor.ConvertirAObjeto<Postulaciones>(
                    JsonConversor.ConvertirAString(datos["Entidad"]));
                var tipo = datos["Tipo"].ToString();

                //Esta linea le manda el StringConnection a aplicacion, el cual internamente le asigna esta conexion al PostulacionesRepositorio
                this.iAplicacion!.Configurar(Configuracion.ObtenerValor("ConectionString")); //Le manda el stringConnection al aplicacion, es necesario para poder usar los metodos de GUARDAR/LISTAR/BORRAR/MODIFCAR...
