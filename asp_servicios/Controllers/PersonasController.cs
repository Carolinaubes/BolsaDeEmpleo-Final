...
namespace asp_servicios.Controllers
{
    ...
    {
        private IPersonasAplicacion? iAplicacion = null; //En PersonasAplicacion estan los metodos ya validados que incluyen las conexiones (los metodos sin validar los tiene PersonasRepositorio)
        ...
        public string Listar()
        {
            ...
            try
            {
                ...
                //Esta linea le manda la el StringConnection a aplicacion, el cual internamente le asigna esta conexion al PersonasRepositorio
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                //Esta linea le manda el StringConnection a aplicacion, el cual internamente le asigna esta conexion al PersonasRepositorio
                this.iAplicacion!.Configurar(Configuracion.ObtenerValor("ConectionString")); //Le manda el stringConnection al aplicacion, es necesario para poder usar los metodos de GUARDAR/LISTAR/BORRAR/MODIFCAR...
