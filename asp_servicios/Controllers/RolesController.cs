...
namespace asp_servicios.Controllers
{
    ...
    {
        private IRolesAplicacion? iAplicacion = null; //En RolesAplicacion estan los metodos ya validados que incluyen las conexiones (los metodos sin validar los tiene RolesRepositorio)
        ...
        public string Listar()
        {
            ...
            try
            {
                ...
                //Esta linea le manda la el StringConnection a aplicacion, el cual internamente le asigna esta conexion al RolesRepositorio
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                //Esta linea le manda el StringConnection a aplicacion, el cual internamente le asigna esta conexion al RolesRepositorio
                this.iAplicacion!.Configurar(Configuracion.ObtenerValor("ConectionString")); //Le manda el stringConnection al aplicacion, es necesario para poder usar los metodos de GUARDAR/LISTAR/BORRAR/MODIFCAR...
