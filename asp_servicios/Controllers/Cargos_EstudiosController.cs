...
namespace asp_servicios.Controllers
{
    ...
    public class Cargos_EstudiosController : ControllerBase
    {
        private ICargos_EstudiosAplicacion? iAplicacion = null; //En Cargos_EstudiosAplicacion estan los metodos ya validados que incluyen las conexiones (los metodos sin validar los tiene Cargos_EstudiosRepositorio)
        private TokenController? tokenController = null; //Se usa para autentificar 

        public Cargos_EstudiosController(ICargos_EstudiosAplicacion? iAplicacion,
        ...
        public string Listar()
        {
            ...
            try
            {
                ...
                //Esta linea le manda la el StringConnection a aplicacion, el cual internamente le asigna esta conexion al Cargos_EstudiosRepositorio
        ...
        public string Buscar()
        {
            ...
            try
            {
                ...
                //En este punto, ya se valido que el token es correcto, continuo...
                var entidad = JsonConversor.ConvertirAObjeto<Cargos_Estudios>(
                    JsonConversor.ConvertirAString(datos["Entidad"]));
                var tipo = datos["Tipo"].ToString();

                //Esta linea le manda el StringConnection a aplicacion, el cual internamente le asigna esta conexion al Cargos_EstudiosRepositorio
                this.iAplicacion!.Configurar(Configuracion.ObtenerValor("ConectionString")); //Le manda el stringConnection al aplicacion, es necesario para poder usar los metodos de GUARDAR/LISTAR/BORRAR/MODIFCAR...
