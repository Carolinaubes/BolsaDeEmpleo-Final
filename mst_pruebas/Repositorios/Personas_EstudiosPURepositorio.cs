...
namespace mst_pruebas.Repositorios
{
    ...
    public class Personas_EstudiosPruebaUnitaria
    {
        ...
        public Personas_EstudiosPruebaUnitaria()
        {
            ...
            iRepositorio = new Personas_EstudiosRepositorio(conexion, iAuditoriasRepositorio);
        }
        ...
        {
            entidad = new Personas_Estudios() //// Este metodo guarda una instancia de Personas_Estudios en la base de datos
            {
                Persona_id = 1,
                Estudio_id = 1
            };
        ...
        private void Listar() //Este metodo lista la instancia Personas_Estudios
        {
